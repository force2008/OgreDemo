...
void BasicTutorial3::createScene(void)
{
	...
	//mSceneMgr->setSkyPlane(true, plane, "Examples/SpaceSkyPlane", 1500, 75);//-y看不到东西
	//mSceneMgr->setSkyPlane(true, plane, "Examples/CloudySky", 1500, 40, true, 1.5f, 150, 150);//-y能看到东西
